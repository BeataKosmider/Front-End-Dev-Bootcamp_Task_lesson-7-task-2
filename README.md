...
```
cd existing_repo
git remote add origin https://gitlab.portal.futurecollars.com/beata_kosmider/lesson-7-task-2.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.portal.futurecollars.com/beata_kosmider/lesson-7-task-2/-/settings/integrations)
